...
[`@aws-sdk/client-mediapackagev2`](https://www.npmjs.com/package/@aws-sdk/client-mediapackagev2/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediapackagev2@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bvyHilXBs2N9nESr+PXXcPS/xN5M1qmzXXHelLvCtOnssp9HtNExmBERGccIBE2w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediapackagev2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediapackagev2@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediapackagev2@3.478.0/index.min.mjs": "sha384-bvyHilXBs2N9nESr+PXXcPS/xN5M1qmzXXHelLvCtOnssp9HtNExmBERGccIBE2w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediapackagev2/blob/refs/tags/3.478.0/LICENSE
```
